  ...
  useEffect(() => {
    ...
    quill.on("text-change", () => {
      ...
      tables.forEach((table) => {
        table.style.tableLayout = "auto"; // Enable dynamic column resizing
        table.style.width = "100%"; // Make table span full width
        ...
        cells.forEach((cell) => {
          ...
          cell.style.resize = "horizontal"; // Allow resizing
          cell.style.overflow = "auto"; // Handle overflowing content
          cell.style.minWidth = "100px"; // Prevent columns from collapsing
        });
      });
