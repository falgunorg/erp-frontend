...
export default function MailList(props) {
  ...
  const smoothScroll = (target, duration) => {
    ...
    const start = inboxRef.current.scrollTop;
    ...
    function animateScroll(timestamp) {
      ...
      const progress = easeInOutQuad(elapsedTime, start, change, duration);
      inboxRef.current.scrollTop = progress;
  ...
  //     inboxRef.current.scrollTop = val;
