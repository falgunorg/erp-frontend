              ...
              {openMenu === "Next" && (
                <ul className="submenu">
                  ...
                  <li>
                    <Link
                      className={
                        location.pathname === "/merchandising/bookings"
                          ? "active"
                          : ""
                      }
                  ...
                  <li>
                    <Link
                      className={
                        location.pathname === "/store/dashboard" ? "active" : ""
                      }
                      to="/store/dashboard"
                    >
                      ST
                  ...
                  <li>
                    <Link
                      className={
                        location.pathname === "/commercial/contracts"
                          ? "active"
                          : ""
                      }
                  ...
                  <li>
                    <Link
                      className={
                        location.pathname === "/commercial/lcs" ? "active" : ""
                      }
                      to="/commercial/lcs"
                    >
                      BB
                  ...
                  <li>
                    <Link
                      className={
                        location.pathname === "/commercial/invoices"
                          ? "active"
                          : ""
                      }
