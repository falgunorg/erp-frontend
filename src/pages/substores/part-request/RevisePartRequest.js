...
export default function RevisePartRequest(props) {
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <input
                          required
                          disabled={
                            !(userInfo.userId === formDataSet.recommended_user)
                          }
                          type="number"
onWheel={(event) => event.target.blur()}
                      ...
                      <td>
                        <input
                          required
                          disabled={!(userInfo.department_title === "Audit")}
                          type="number"
onWheel={(event) => event.target.blur()}
                          min="0"
                          className="form-control"
...
onWheel={(event) => event.target.blur()}
                      ...
                      <td>
                        <input
                          required
                          disabled={!(userInfo.department_title === "Purchase")}
                          type="number"
onWheel={(event) => event.target.blur()}
                          min="0"
                          step="0.01"
