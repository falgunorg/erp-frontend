...
export default function AdminSorDetails(props) {
  ...
  const getSor = async () => {
    setSpinner(true);
    var response = await api.post("/admin/sors-show", { id: params.id });
    ...
    <div className="create_edit_page">
      ...
      <div className="create_page_heading">
        ...
        <div className="actions">
          ...
          <Link to="/admin/sors" className="btn btn-danger">
              ...
              <table className="table table-striped text-start align-middle table-bordered table-hover mb-0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <img className="" src={sor.image_source} />
                    </td>
