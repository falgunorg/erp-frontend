  ...
  const getPurchase = async () => {
    ...
    if (response.status === 200 && response.data) {
      ...
      setFormDataSet({
        ...
        techpack_id: purchase.techpack_id,
        sizes: purchase.sizes ? purchase.sizes.split(",").map(Number) : [],
        colors: purchase.colors ? purchase.colors.split(",").map(Number) : [],
        shipping_method: purchase.shipping_method,
        order_date: purchase.order_date,
        shipment_date: purchase.shipment_date,
        lead_time: purchase.lead_time,
        booking_time: purchase.booking_time,
        material_inhouse_time: purchase.material_inhouse_time,
        production_time: purchase.production_time,
        save_time: purchase.save_time,
        delivery_address: purchase.delivery_address,
        packing_instructions: purchase.packing_instructions,
        packing_method: purchase.packing_method,
