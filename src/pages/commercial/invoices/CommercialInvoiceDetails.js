  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Keep header and main title normal size */
        .invoice-body h4,
        .invoice-body h3 {
      ...
      <div className="container-fluid bg-light py-4">
        ...
        <div
          className="bg-white p-4 shadow mx-auto invoice-body"
        ...
        >
          ...
          <div className="d-flex justify-content-between border-bottom pb-3">
            ...
            <div className="text-center">
              ...
              <div>
                Phone: {invoice.contract.company.phone}, Email:
                {invoice.contract.company.email}
              </div>
            </div>
            <img
              alt="logo"
          ...
          <div className="row mt-4">
            <div className="col-6">
              <div className="border p-3">
                ...
                <p className="mb-1">
                  <strong>Phone:</strong> {invoice.contract?.buyer?.phone}
                </p>
                <p className="mb-1">
                  <strong>Email:</strong> {invoice.contract?.buyer?.email}
                </p>
              </div>
            </div>
            ...
            <div className="col-6">
              <div className="border p-3">
                ...
                <p className="mb-1">
                  <strong>Phone:</strong> {invoice.contract?.company?.phone}
                </p>
                <p className="mb-1">
                  <strong>Email:</strong> {invoice.contract?.company?.email}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row mt-4">
            <div className="col-6">
              <div className="border p-3">
                ...
                <p className="mb-1">
                  ...
                  {invoice.contract.bank.account_number}
                </p>
                <p className="mb-1">
            ...
            <div className="col-6">
              <div className="border p-3">
                ...
                <p className="mb-1">
                  <strong>Carrier/Forwarder:</strong>{" "}
                  {invoice.carrier_forwarder_name}
                </p>
          ...
          {/* Goods Table */}
          <p className="fw-bold text-decoration-underline mb-1  mt-4">
            DETAILS OF PRODUCT
          </p>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ${" "}
                  {invoice.pcs_qty
                    ? (invoice.exp_value / invoice.pcs_qty).toFixed(2)
                    : "0.00"}
                </td>

                <td className="fw-bold">$ {invoice.exp_value}</td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="row mt-3">
            <div className="col-4">
              <div className="border p-2">
                <strong>Total Gross Weight:</strong> {invoice.gross_weight_kg}{" "}
                KG
              </div>
            </div>
            <div className="col-4">
