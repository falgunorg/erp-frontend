...
export default function EditMachine(props) {
  ...
  const getMachine = async () => {
    setSpinner(true);
    var response = await api.post("/machines-show", {
      id: params.id,
    });
    if (response.status === 200 && response.data) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (validateForm()) {
      ...
      var response = await api.post("/machines-update", data);
    ...
    <div className="create_edit_page">
      ...
      <form onSubmit={handleSubmit}>
        <div className="create_page_heading">
          <div className="page_name">Update Machine</div>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-5">
            ...
            <div className="form-group text-center">
              ...
              >
                <img
                  src={imagePreview ? imagePreview : formData.image_source}
                  alt="Preview"
