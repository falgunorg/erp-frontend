...
export default function WorkOrders(props) {
  ...
  const [workOrders, setWorkOrders] = useState(
    Array.from({ length: 50 }, (_, index) => {
      ...
      return { value: `PCNXF1JM${serial}`, label: `PCNXF1JM${serial}` };
    })
  );
      ...
      >
        <div className="col">
          <div className="purchase_sidebar">
            ...
            <div className="email-section">
              <div className="folder_name">Purchase Order</div>
              <Select
                className="select_wo"
                placeholder="Search Or Select"
                options={workOrders}
            ...
            <div className="email-section">
              <div className="folder_name">Vendor</div>
              <Select
                className="select_wo"
                placeholder="Search Or Select"
                options={workOrders}
            ...
            <div className="email-section">
              <div className="folder_name">Style</div>
              <Select
                className="select_wo"
                placeholder="Search Or Select"
                options={workOrders}
          ...
          <div className="purchase_list">
            <div className="purchase_list_header d-flex justify-content-between">
              <div className="purchase_header_left">
                <div className="title">
                  <input type="checkbox" /> PC View
                </div>
                <div className="buttons_group">
                  <button>All</button>
                  <button>Urgent</button>
                  <button>Unassigned PC</button>
                </div>
              </div>
              <div className="purchase_header_left">
              ...
              <div className="details_header d-flex justify-content-between">
                <div className="">
                  <img
                    ...
                    alt="Logo"
                  />
                  <span className="purchase_text"> Purchase Contract</span>
                </div>

                <div className="left_side d-flex gap_10">
                  <div className="buttons_group">
                    <button>#PCAR343535</button>
                  </div>
                </div>
              </div>
              <div className="">
