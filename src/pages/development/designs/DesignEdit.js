...
export default function DesignEdit(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (validateForm()) {
      ...
      setSpinner(true);
      var response = await api.post("/designs-update", data);
  ...
  const getDesign = async () => {
    ...
    if (response.status === 200 && response.data) {
      ...
      setFormData({
        ...
        buyers: designData.buyers.split(",").map(Number),
        id: designData.id,
      });
      setDesignItems(designData.design_items);
    ...
    <div className="create_edit_page">
      ...
      <form onSubmit={handleSubmit}>
        <div className="create_page_heading">
          <div className="page_name">Edit Article</div>
        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            <div className="attachment_list margin_top_0">
              {design && design.attachments && design.attachments.length > 0
