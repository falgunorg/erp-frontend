...
export default function SubStore(props) {
  ...
  useEffect(async () => {
    getSubstores();
  }, [currentPage, props.headerData.innerSearchValue, params.type]);
  ...
  useEffect(async () => {
    props.setHeaderData({
      ...
      isDropdown: true,
      DropdownMenu: [
        { title: "All", url: "/sub-stores" },
        { title: "Stationery", url: "/sub-stores/Stationery" },
        { title: "Spare Parts", url: "sub-stores/Spare Parts" },
        { title: "Electrical", url: "/sub-stores/Electrical" },
        { title: "Needle", url: "/sub-stores/Needle" },
        { title: "Medical", url: "/sub-stores/Medical" },
        { title: "Fire", url: "/sub-stores/Fire" },
        {
          title: "Compressor & boiler",
          url: "/sub-stores/Compressor & boiler",
        },
        { title: "Chemical", url: "/sub-stores/Chemical" },
        { title: "Printing", url: "/sub-stores/Printing" },
        { title: "It", url: "/sub-stores/It" },
        { title: "WTP", url: "/sub-stores/WTP" },
        { title: "Vehicle", url: "/sub-stores/Vehicle" },
        { title: "Compliance", url: "/sub-stores/Compliance" },
      ],
    });
  }, []);
