...
export default function SubStoreIssueReport(props) {
  ...
  const totalSum = reports.reduce((sum, item) => sum + item.qty, 0);
  ...
  return (
    <div className="create_edit_page">
      ...
      <div className="create_page_heading">
        <div className="page_name">SubStore Issue Report</div>
          ...
          <div className="col">
            <div className="form-group">
              ...
              <Select
                placeholder="Select"
                value={
                  employees.find((item) => item.id === filterData.employee_id)
                    ? {
                        value: filterData.employee_id,
                        label:
                          employees.find(
                            (item) => item.id === filterData.employee_id
                          ).full_name || "",
                      }
                    : null
                }
                onChange={(selectedOption) =>
                  filterChange("employee_id", selectedOption.value)
                }
                name="employee_id"
          ...
          <div className="table-container preview_print">
            <div className="table-responsive">
              <div className="text-center">
                <h4>FALGUN | ERP</h4>
                <h5>SubStore Issue {reportSummary.part_type} Statement</h5>
                <h6>
                ...
                {reportSummary.employee && (
                  <h6>EMP/SEC: {reportSummary.employee}</h6>
                )}
                  ...
                  <>
                    {reports.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          <strong>
                            {moment(item.issue_date).format("ll")}
                          </strong>
                        </td>
                        <td>
