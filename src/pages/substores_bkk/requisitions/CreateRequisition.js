...
export default function CreateRequisition(props) {
  ...
  const handleItemChange = (index, field, value) => {
    ...
    if (field === "part_id") {
      ...
      if (selectedItem) {
        ...
        updatedItems[index].stock_in_hand = parseInt(
          selectedItem.stock_in_hand
        );
      } else {
    ...
    <div className="create_edit_page">
      ...
      <form onSubmit={handleSubmit}>
        <div className="create_page_heading">
          <div className="page_name">Create Requisition</div>
