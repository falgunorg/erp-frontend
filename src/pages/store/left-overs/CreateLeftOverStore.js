...
export default function CreateLeftOverStore(props) {
  ...
  const addStore = async (item_id) => {
    const result = await swal({
      title: "Do you want to add into store ?",
      icon: "success",
      buttons: ["No", "Yes"],
      dangerMode: false,
    });
  ...
  return (
    <div className="create_edit_page">
      ...
      <div className="create_page_heading">
        <div className="page_name">Left Over Add</div>
